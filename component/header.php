...
<header>
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:justify-end">
            <? if ($is_logged_in) { ?>
                <div class="mr-2">Hi, <?= $user->name ?></div>
                <a href="/cart" class="mr-12">
            ...
            <? } ?>
            <? if (!$is_logged_in) { ?>
                <a href="/auth/login" class="text-sm font-semibold leading-6 text-neutral-900">Log in <span aria-hidden="true">&rarr;</span></a>
            <? } else { ?>
                <a href="/auth/logout" class="text-sm font-semibold leading-6 text-neutral-900">Log out <span aria-hidden="true">&rarr;</span></a>
            <? } ?>
        </div>
    </nav>
</header>